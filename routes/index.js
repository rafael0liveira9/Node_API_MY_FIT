...
router.get('/friends', async (req, res) => relations.GetMyFriends(req, res)),
    router.get('/personals', async (req, res) => relations.GetMypersonals(req, res)),
    ...
    router.get('/personal-evaluations', async (req, res) => { const { personalId, evaluation } = req.query; relations.GetPersonalEvaluations(req, res, personalId, evaluation) }),
    router.post('/personal-evaluate', async (req, res) => relations.PostPersonalEvaluation(req, res)),
